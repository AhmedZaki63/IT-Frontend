...
window.Bdaya = {
    ...
    init: function() {
        "use strict";
        var t;
        return t = new Bdaya.Router, Backbone.history.start({
            pushState: !0,
            hashChange: !1,
            root: "/"
        })
    ...
    "use strict";
    return Bdaya.init()
}), Bdaya.Router = function(t) {
    function e() {
        return e.__super__.constructor.apply(this, arguments)
    }
    return extend(e, t), e.prototype.elements = {}, e.prototype.routes = {
        "blog/(:article/)": "blog",
        "projects/": "projects",
        "projects-categories/(:category/)": "projects",
        "": "home"
    }, e.prototype.blog = function() {
        return console.log("blog")
    }, e.prototype.projects = function() {
        return new Bdaya.Views.ProjectsPage
    }, e.prototype.home = function() {
        return new Bdaya.Views.HomePage, new Bdaya.Views.EventsSection, this.elements.navigation.bindScrollEvent()
    }, e.prototype.initialize = function() {
        return new IntroSection, this.elements.navigation = new Bdaya.Views.Navigation
    }, e
}(Backbone.Router);
var extend = function(t, e) {
        function o() {
    ...
    hasProp = {}.hasOwnProperty;
Bdaya.Views.HomePage = function(t) {
    function e() {
        return e.__super__.constructor.apply(this, arguments)
    }
    return extend(e, t), e.prototype.el = "#front-page", e.prototype.initialize = function() {
        return $("#partners-section .partners-list").slick({
            infinite: !0,
            slidesToShow: 4,
            slidesToScroll: 1,
            responsive: [{
...
var extend = function(t, e) {
    ...
    hasProp = {}.hasOwnProperty;
Bdaya.Views.EventsSection = function(t) {
    function e() {
        return e.__super__.constructor.apply(this, arguments)
    }
    return extend(e, t), e.prototype.el = "#events-section", e.prototype.initialize = function() {
        var t, e;
        return e = this.$(".event-countdown").attr("data-timestamp"), console.log(e), t = function(t) {
            return function(e) {
                return t.$(".event-countdown .days").text(e.days), t.$(".event-countdown .minutes").text(e.minutes), t.$(".event-countdown .hours").text(e.hours)
            }
        }(this), countdown(1e3 * e, t, countdown.DAYS | countdown.HOURS | countdown.MINUTES)
    }, e
}(Backbone.View);
var BdayaIntro, ColoredDot, Dot, coloredDotIndex, pixelRatio, random, toRad, extend = function(t, e) {
        function o() {
            this.constructor = t
        }
        for (var i in e) hasProp.call(e, i) && (t[i] = e[i]);
...
BdayaIntro = function() {
...
}(), coloredDotIndex = 0, ColoredDot = function(t) {
    function e(t, o, i, n, s, r) {
        ...
        e.__super__.constructor.call(this, o, i, n, s, r), this.el.style.backgroundColor = t, a = this.index = coloredDotIndex, coloredDotIndex++, 0 === this.index && $(this.el).addClass("selected"), this.el.addEventListener("mouseover", function() {
            return $(this).addClass("selected"), $(this).siblings().removeClass("selected"), $("#intro-section .banner li").removeClass("selected").eq(a).addClass("selected")
        })
    }
...
}(Dot), random = function(t, e) {
    return Math.floor(Math.random() * (e - t + 1) + t)
}, toRad = function(t) {
    return t * Math.PI / 180
}, pixelRatio = function(t) {
    var e, o;
    return o = window.devicePixelRatio || 1, e = t.webkitBackingStorePixelRatio || t.mozBackingStorePixelRatio || t.msBackingStorePixelRatio || t.oBackingStorePixelRatio || t.backingStorePixelRatio || 1, o / e
};
var IntroSection, extend = function(t, e) {
        function o() {
            this.constructor = t
        }
        for (var i in e) hasProp.call(e, i) && (t[i] = e[i]);
...
IntroSection = function(t) {
    ...
    return extend(e, t), e.prototype.el = "#intro-section", e.prototype.initialize = function() {
        var t;
        return t = this.$(".dots"), new BdayaIntro(t)
    }, e
}(Backbone.View);
var extend = function(t, e) {
        function o() {
    ...
    hasProp = {}.hasOwnProperty;
Bdaya.Views.Navigation = function(t) {
    function e() {
        return e.__super__.constructor.apply(this, arguments)
    }
    return extend(e, t), e.prototype.el = "#site-navigation", e.prototype.initialize = function() {
        return this.containerHeight = $("#intro-section").height(), this.navOffsetTop = this.containerHeight - this.$el.outerHeight(), this.$(".menu-list-wrapper-mobile .toggle-menu").click(function(t) {
            return function() {
                return t.$(".menu-list-wrapper-mobile ul").toggleClass("active")
            }
        }(this)), $("a").click(function(t) {
            /* here */
            var e, o;
            return o = $(this).attr("href"), o.startsWith("#") ? (t.preventDefault(), e = $(o), e.length ? $("html, body").stop().animate({
                scrollTop: e.offset().top
            }, 500, "swing", function() {
                return window.location = "/" + o
            }) : window.location = "/" + o) : void 0
        })
    }, e.prototype.bindScrollEvent = function() {
        var t;
        return this.$el.css({
            top: this.containerHeight - this.$el.outerHeight(),
            zIndex: 120
        }), t = function(t) {
            return function() {
                var e, o;
                return o = $(document).scrollTop(), e = t.navOffsetTop - o, 0 > e ? (t.$el.removeClass("center-mode"), t.$el.css({
                    top: 0
                })) : e > 0 ? (t.$el.addClass("center-mode"), t.$el.css({
                    top: t.containerHeight - t.$el.outerHeight()
                })) : void 0
            }
        }(this), t(), $(document).on({
            "scroll.stickyNavigation": t
        })
    }, e
}(Backbone.View);
var extend = function(t, e) {
    ...
    hasProp = {}.hasOwnProperty;
Bdaya.Views.ProjectsPage = function(t) {
    function e() {
        return e.__super__.constructor.apply(this, arguments)
    }
    return extend(e, t), e.prototype.el = "#projects-page", e.prototype.initialize = function() {
        return this.header = this.$(".site-page-header"), this.headerDeafaults = this.header.clone(), this.bindEvents()
    }, e.prototype.bindEvents = function() {
        var t, e, o, i, n;
        return t = this.header, n = this.header.find(".site-page-subtitle"), e = this.headerDeafaults, o = function() {
            var e, o, i, s;
            return e = $(this).find(".action-circle"), i = $(this).find(".icon"), o = $(this).attr("data-color"), s = $(this).attr("data-name"), i.css({
                color: "white"
            }), e.css({
                background: o
            }), t.addClass("category-mode"), t.css({
                "background-color": o
            }), n.text(s)
        }, i = function() {
            var o, i, n, s;
            return o = $(this).find(".action-circle"), n = $(this).find(".icon"), i = $(this).data("color"), n.css({
                color: i
            }), o.css({
                background: "white"
            }), s = e.css("background-color"), t.removeClass("category-mode"), t.css({
                "background-color": s
            })
        }, this.$(".projects-categories li:not(.selected)").hover(o, i)
    }, e
}(Backbone.View);
